    ...
    group('sharePhoto', () {
      ...
      test('returns correct share urls', () async {
        ...
        expect(
          ...
          equals(
            'https://io-photobooth-devfest-rv.web.app/share/photo.jpg',
          ),
        );
        expect(
          shareUrls.facebookShareUrl,
          equals(
            'https://www.facebook.com/sharer.php?u=https://io-photobooth-devfest-rv.web.app/share/photo.jpg&quote=Share%20text',
          ),
        );
        expect(
          shareUrls.twitterShareUrl,
          equals(
            'https://twitter.com/intent/tweet?url=https://io-photobooth-devfest-rv.web.app/share/photo.jpg&text=Share%20text',
          ),
        );
      });
